...
with modelTraining:
    ...
    st.text('En esta seccion puedes seleccionar los params del modelo')
...
max_depth = st.slider('Cuál debería ser el valor del max_depth para el modelo?', min_value=1, max_value=10, value =7, step = 1)
